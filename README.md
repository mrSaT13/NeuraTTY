...
- 🔑 SSH-ключ опционально: тумблер, по умолчанию — логин/пароль
...
1. Скачайте `NeuraTTY_Installer_v1.8.exe` из [Releases](https://github.com/mrSaT13/NeuraTTY/releases)
...
- [x] Опциональный SSH-ключ (тумблер, иначе логин/пароль)
